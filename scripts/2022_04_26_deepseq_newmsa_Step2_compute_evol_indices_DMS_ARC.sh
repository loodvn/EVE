...
#SBATCH --job-name="eve_deepseq_dms_v6_online_loop_bool"
...
export output_evol_indices_location='./results/evol_indices_20220501_v5_memory/online_loop_bool'  # Experimental output location
