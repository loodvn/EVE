    ...
    def __init__(self, params):
        ...
        if self.convolve_output:
            ...
            self.output_convolution_log_var = nn.Conv1d(
                in_channels=self.convolution_depth, out_channels=self.alphabet_size, kernel_size=1, stride=1, bias=False
            )
...
class VAE_Standard_MLP_decoder(nn.Module):
    ...
    def __init__(
        ...
        hidden_layers_sizes,
        z_dim,
        first_hidden_nonlinearity,
        last_hidden_nonlinearity,
        dropout_proba,
        convolve_output,
        convolution_depth,
        include_temperature_scaler,
        include_sparsity,
        num_tiles_sparsity,
    ):
        """
