...
def parse_args():
    ...
    parser.add_argument('--seeds', type=int, nargs="+",
                        help='Random seeds of VAE checkpoints to load (can specify one or several)')
    ...
    parser.add_argument('--num_samples_compute_evol_indices', type=int,
...
if __name__=='__main__':
    ...
    # Use MSA_filename, because UniProt_ID is not unique
    ...
    data = data_utils.MSA_processing(
            ...
            skip_one_hot_encodings=True,  # One-hot encodings computed on the fly
            **data_kwargs,
    )

    args.mutations_location = os.path.join(args.DMS_data_folder, DMS_filename)
